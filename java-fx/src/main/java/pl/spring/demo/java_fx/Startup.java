package pl.spring.demo.java_fx;
...
public class Startup extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		primaryStage.setTitle("Angular-JavaFX");

		/*
		 * Load screen from FXML file with specific language bundle (derived
		 * from default locale).
		 */
		Parent root = FXMLLoader.load(getClass().getResource("/pl/spring/demo/java_fx/view/book-search.fxml"), //
				ResourceBundle.getBundle("pl/spring/demo/java_fx/bundle/base"));
		 ...
		 */
		scene.getStylesheets().add(getClass().getResource("/pl/spring/demo/java_fx/css/standard.css").toExternalForm());
